...
const InteractiveBentoGallery: React.FC<InteractiveBentoGalleryProps> = ({ mediaItems, title, description, footer }) => {
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            {/* Optional footer (e.g. an Instagram CTA) rendered under the grid, hidden while the modal is open */}
            {footer && !selectedItem && (
                <motion.div
